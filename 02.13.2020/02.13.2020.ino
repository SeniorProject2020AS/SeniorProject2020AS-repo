...
// Progress apprear 1 by 1 on Stepper stage OneByOneProgress=1 (with the jump issue on stepper each change of progress)
// Progress apprear 10 by 10 on Stepper stage OneByOneProgress=0
int OneByOneProgress = 0;
...
void loop()
{
  if (currentstatus == RUNNING) {
    ...
    int updateprogress;
    if (OneByOneProgress == 1 || (OneByOneProgress == 0 && (calculatedSecond < 265 || calculatedSecond > (265 + 60)))) {
      // progress 1 by 1
