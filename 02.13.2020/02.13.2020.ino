...
void setup() {
  ...
  NaAlgPump->setSpeed(255); // Sets speed of motor
  NaAlgPump->run(FORWARD); // Sets direction of motor
  NaAlgPump->run(RELEASE); // Stops motor

  BlenderStomach->setSpeed(30); // Sets speed of motor
  BlenderStomach->run(FORWARD); // Sets direction of motor
  BlenderStomach->run(RELEASE); // Stops motor

  CalciumBathPump->setSpeed(255); // Sets speed of motor
  CalciumBathPump->run(FORWARD); // Sets direction of motor
  CalciumBathPump->run(RELEASE); // Stops motor

  CalciumBathExtractionPump->setSpeed(255); // Sets speed of motor
  CalciumBathExtractionPump->run(FORWARD); // Sets direction of motor
